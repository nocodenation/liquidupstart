...
| `docs/FEATURE-liquid-java-extensions.md` | The same, for the Java extensions. Numbering continues from the git document — U9, FR21 upward — so no `Covers:` row is ambiguous |
| `docs/TEST-SPEC-liquid-java-extensions.md` | The Java cases. One harness, two specifications: everything runs from `tests/` |
