...
| # | Deliverable                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Mode |
|---|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---|
| **0** | **Prototype (standalone).** `PrM4breal `/v1/messages` payload + custom recognizers + detect-secrets, **European-language** (en/de/fr/es/it/pt, per-language NER + lingua), with the local-LLM second pass + sufficiency score. Validates surrogate quality, reversal, language coverage. **Collision acceptance bar:** on a labelled corpus of real payloads, **zero false restores** + ≥ target correct-restore rate, surrogate-regeneration rate logged.                                                                                                                                                                   | — |
